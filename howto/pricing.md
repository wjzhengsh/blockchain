...
Both Starter Plan and Enterprise Plan has two pricing elements:
...
*Figure 4. Charge of a default Starter Plan network with trial credits applied*

#### Additional peers
Starter Plan does not restrict the number of peers that you can add to your network. If you add, for example, two peers to the default Starter Plan network, one for each of your organizations, you increase your bill by $250 per month. Your bill is reflected in Figure 5 if you add two additional peers at the beginning of the first month when you create or join a Starter Plan network and consume the trial credits.
...
*Figure 7. Charge of a default Starter Plan network with extending credits*
...
*Figure 8. Charge of a basic Enterprise Plan network*

### Example Enterprise Plan pricing

#### Additional peers
Continue with the example above, if you add another two peers to your organization. You bill increases by $2000 per month. Your bill is reflected in Figure 9:
...
*Figure 9. Charge of an Enterprise Plan network with four peers*
...
*Figure 10: Charge of two Enterprise Plan networks both with basic network configuration*

If the other member uses only one Enterprise Plan network and keeps the same network configuration, the member’s bill looks the same as before, which is reflected in Figure 8.
