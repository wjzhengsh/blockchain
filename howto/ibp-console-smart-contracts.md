...
4. What happens when I remove an organization from my private data collection?
   ...
   That organization will continue to be able to see the existing data in the private data collection. But they will not have access to the private data in any future transactions, after the smart contract is instantiated on the channel with the new collection configuration definition.
