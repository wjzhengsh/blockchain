...
Now that your console is ready to use, you can go ahead [build a network](/docs/services/blockchain/howto/ibp-console-build-network.html#ibp-console-build-network).
