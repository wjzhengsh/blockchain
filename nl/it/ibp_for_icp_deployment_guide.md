...
Le reti blockchain che sono basate su [Hyperledger Fabric ![Icona link esterno](images/external_link.svg "Icona link esterno")](https://hyperledger-fabric.readthedocs.io/en/release-1.4/) possono essere distribuite in una gamma quasi illimitata di configurazioni per supportare altrettanti casi d'uso. Nonostante questa malleabilità, esiste un certo numero di prassi ottimali, soprattutto per quanto riguarda la corretta **sequenza** per configurare e distribuire i componenti di rete.
