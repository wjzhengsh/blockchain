...
Consulta l'[esercitazione sullo sviluppo di applicazioni](v10_application.html) per informazioni su come effettuare l'[iscrizione utilizzando l'SDK Node Fabric](v10_application.html#enroll-app). L'iscrizione con l'SDK genera 3 elementi separati: una chiave privata, signCert e una chiave pubblica che è stata utilizzata per creare il signCert.
...
Per un esempio di dove ti iscrivi utilizzando il client CA Fabric e utilizzi i certificati generati per gestire un componente di rete, vedi le istruzioni in [Gestione di un peer remoto](howto/peer_operate_icp.html#peer-cli-operate).
