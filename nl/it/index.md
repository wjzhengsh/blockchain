...
Il piano Starter e il piano Enterprise sono servizi di piattaforma su {{site.data.keyword.cloud_notm}} ed entrambi i piani si attengono ai termini dei servizi [termini dei servizi {{site.data.keyword.cloud_notm}}![Icona link esterno](images/external_link.svg "Icona link esterno")](https://www-03.ibm.com/software/sla/sladb.nsf/sla/bm-6605-13 "{{site.data.keyword.cloud_notm}}") negli SLA (service level agreement). Nota che il provisioning di entrambe le reti piano Starter e piano Enterprise viene eseguito in **più ambienti** in data center geograficamente separati.
