...
- **Intégration de l'application _{{site.data.keyword.blockchainfull_notm}} Platform: Develop_**
    Le plan Starter vous permet de déployer des réseaux d'entreprise que vous avez développés sur [{{site.data.keyword.blockchainfull_notm}} Platform : Develop](https://blockchaindevelop.mybluemix.net/login). Pour plus d'informations, voir [Déploiement d'un réseau d'entreprise sur un plan Starter](/docs/services/blockchain/develop_starter.html).
...
- **Crédits de cloud {{site.data.keyword.blockchainfull_notm}} Platform**
    ...
    Pour en savoir plus sur l'utilisation des crédits restants, consultez le [guide de tarification](/docs/services/blockchain/howto/pricing.html#starter-plan-pricing).
- **Différences par rapport au plan Enterprise**
    - L'[autorité de certification (CA)](/docs/services/blockchain/glossary.html#ca) et le [service de tri](/docs/services/blockchain/glossary.html#orderer) ne sont pas tolérants aux pannes car chaque organisation ne dispose que d'une seule autorité de certification et un réseau n'a qu'un seul [service de tri](/docs/services/blockchain/glossary.html#orderer).
    - Le service de tri utilise uniquement le [consensus](/docs/services/blockchain/glossary.html#consensus) [SOLO](/docs/services/blockchain/glossary.html#solo). Un réseau de plan Starter ne comporte qu'un seul [service de tri](/docs/services/blockchain/glossary.html#orderer) qui effectue le consensus pour tous les homologues.
    - Aucun [Module de sécurité matérielle (HSM)](/docs/services/blockchain/glossary.html#hsm) n'est disponible pour la sauvegarde et la gestion des clés numériques pour une authentification forte et le traitement du chiffrement.
- **Versions et mise à niveau du plan Starter**
    ...
    - Vous pouvez utiliser la fonction [Données privées![Icône de lien externe](images/external_link.svg "Icône de lien externe")](https://hyperledger-fabric.readthedocs.io/en/release-1.2/private-data-arch.html "Données privées") de  Hyperledger Fabric version 1.2 dans les nouveaux réseaux de plan Starter. Pour plus d'informations sur la manière d'utiliser vos données privées avec le code blockchain, voir [Données privées](/docs/services/blockchain/howto/develop_chaincode.html#private-data).
