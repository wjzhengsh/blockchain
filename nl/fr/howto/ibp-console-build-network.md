...
1. Sur la console, utilisez l'onglet **Noeuds** pour accéder à l'autorité de certification `AC Org1` que vous avez créée.
2. Une fois l'autorité de certification sélectionnée, vous devrez enregistrer un admin pour notre première organisation, `org1`, ainsi qu'une identité pour l'homologue lui-même. Vous devez déjà voir une identité sur cette page ; il s'agit de l'admin que vous avez créé pour l'autorité de certification. Pour enregistrer nos nouveaux utilisateurs, cliquez sur le bouton **Enregistrement d'utilisateur**.
...
6. Le dernier panneau latéral vous invite à **Associer une identité** et à la définir en tant qu'admin de votre homologue. Sélectionnez votre identité admin homologue `Admin Org1`.
...
1. Sur la console, cliquez sur l'onglet **Noeuds** et cliquez sur le `CA service de tri` que vous avez créé.
2. Lorsque l'identité admin que vous venez de créer apparaît dans le tableau, cliquez sur le bouton **Enregistrement d'utilisateur** pour enregistrer nos nouveaux utilisateurs.
...
7. Passez en revue le récapitulatif et cliquez sur **Ajouter un service de tri**.
...
Lorsque vous êtes prêt(e), cliquez sur **Créer un canal**. Vous devez retourner à l'onglet Canaux.
...
Comme créer un canal et joindre un homologue à un canal constituent deux étapes distinctes, gérées par les flux derrière les deux boutons, vous ne verrez pas le canal que vous avez créé sur cet écran tant que vous n'aurez pas joint un homologue au canal.
{:note}
...
1. Cliquez sur **Joindre un canal** pour lancer les panneaux latéraux.
2. Sélectionnez votre `Service de tri` et cliquez sur **Suivant**.
3. Entrez le nom du canal que vous venez de créer `canal1` et cliquez sur **Suivant**.
4. Sélectionnez les homologues qui doivent rejoindre le canal. Pour les besoins de ce tutoriel, cliquez sur `Org1 homologue`.
