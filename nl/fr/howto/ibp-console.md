...
La version bêta gratuite 2.0 d'{{site.data.keyword.blockchainfull_notm}} Platform est la génération suivante des offres {{site.data.keyword.blockchainfull_notm}} Platform, qui vous donne un contrôle total sur vos déploiements et certificats. Cette version bêta gratuite inclut la nouvelle console {{site.data.keyword.blockchainfull_notm}} Platform, une interface utilisateur qui peut simplifier et accélérer le processus de déploiement de composants dans un service {{site.data.keyword.cloud_notm}} Kubernetes géré et contrôlé par vous.
{:shortdesc}
...
- **Intégration de service {{site.data.keyword.cloud_notm}}.** Optimisez les services {{site.data.keyword.cloud_notm}} intégrés, tels que {{site.data.keyword.cloud_notm}} Kubernetes Service Dashboard, {{site.data.keyword.cloud_notm}} Logging et Metrics Service, ainsi que {{site.data.keyword.cloud_notm}} Identity Service.
...
A l'avenir, vous aurez la possibilité de migrer d'une version de plan Enterprise vers {{site.data.keyword.blockchainfull_notm}} Platform 2.0 lorsque cette offre sera en disponibilité générale (GA).   
