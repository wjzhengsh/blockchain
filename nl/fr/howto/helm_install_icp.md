...
Avant d'installer la charte Helm, vous devez avoir configuré un cluster ICP. Passez en revue les instructions relatives à la [définition et à la configuration d'un cluster ICP](../ICP_setup.html).
