...
- Sécurité améliorée avec les fonctions suivantes :
  ...
  - [HSM (Hardware secure module)](/docs/services/blockchain/glossary.html#hsm) pour la gestion et le stockage des clés.
...
[Tarification du plan Enterprise](/docs/services/blockchain/howto/pricing.html#enterprise-plan-pricing).
...
Vous devez créer un réseau de plan avant de migrer. Pour plus d'informations, voir [Création d'un réseau de plan Enterprise](/docs/services/blockchain/get_start.html#creating-a-network).
...
2. Recréez des organisations (membres) à l'écran "Membres", recréez des canaux à l'écran "Canaux", puis recréez des homologues à l'écran "Présentation". Pour plus d'informations sur la création de ressources réseau, voir [Utilisation du Moniteur réseau](/docs/services/blockchain/v10_dashboard.html#overview).
