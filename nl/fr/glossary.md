...
## Code blockchain
Egalement appelé **smart contracts**, le code blockchain est constitué d'éléments logiciels qui contiennent un ensemble de fonctions permettant d'interroger et de mettre à jour le registre.
...
## Smart contracts
Voir [Code blockchain](#chaincode).
