...
Antes de instalar o gráfico Helm, deve-se ter configurado um cluster ICP. Revise as instruções para [instalar e configurar um cluster ICP](../ICP_setup.html).
