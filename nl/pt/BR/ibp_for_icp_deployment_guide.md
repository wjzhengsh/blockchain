...
As redes de blockchain que são baseadas no [Hyperledger Fabric ![Ícone de link externo](images/external_link.svg "Ícone de link externo")](https://hyperledger-fabric.readthedocs.io/en/release-1.4/) podem ser implementadas em uma matriz praticamente ilimitada de configurações para suportar diversos casos de uso. Apesar dessa maleabilidade, existe uma série de melhores práticas, especialmente em torno da **sequência** adequada para configurar e implementar componentes de rede.
...
Esse guia de implementação não abordará todas as possíveis iterações e configurações de rede, mas oferecerá diretrizes e regras comuns a serem consideradas.
{:note}
...
Também é possível usar o {{site.data.keyword.IBM_notm}} Secure Service Container como o host para que o {{site.data.keyword.cloud_notm}} Private possa utilizar as vantagens de segurança do Secure Service Container para proteger dados críticos contra ameaças internas e externas. Para obter mais informações, consulte [Usando o {{site.data.keyword.IBM_notm}} Secure Service Container for {{site.data.keyword.cloud_notm}} Private](/docs/services/howto/ibp-ssc-for-icp.html "Usando o {{site.data.keyword.IBM_notm}} Secure Service Container for {{site.data.keyword.cloud_notm}} Private").
{:note}
...
1. Antes de poder incluir uma organização, é necessário criá-la e configurar seu ID do MSP. Veja [Operando uma CA](/docs/services/blockchain/howto/CA_operate.html#ca-operate-deploy-orderer-peer).
...
- [Tutorial: operar um peer distribuído no {{site.data.keyword.blockchainfull_notm}} Platform](https://developer.ibm.com/tutorials/operate-distributed-peer-on-ibm-blockchain-platform/)
- [Página inicial do {{site.data.keyword.cloud_notm}} Private](https://www.ibm.com/cloud/private "Página inicial do {{site.data.keyword.cloud_notm}} Private")
- [Documentação do {{site.data.keyword.cloud_notm}} Private](https://www.ibm.com/support/knowledgecenter/en/SSBS6K_3.1.2/kc_welcome_containers.html)
