...
**Notas**:
1. El Plan inicial de la plataforma {{site.data.keyword.blockchainfull}} es un entorno de desarrollo y de prueba, y no es adecuado para las cargas de trabajo de producción. Si necesita un entorno de producción, consulte [Acerca del Plan empresarial](enterprise_plan.html).
...
2. Asegúrese de elegir **EE.UU. Sur** como región en {{site.data.keyword.cloud_notm}}.
3. Seleccione su organización y espacio de Cloud Foundry, donde creará la red.
