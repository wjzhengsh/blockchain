...
El nombre de la red blockchain está en la parte superior del panel de navegación de la izquierda. Puede [cambiar el nombre de la red](#network-name) en el Supervisor de red.
...
El Plan inicial y el Plan empresarial se integran con la función de desarrollo de la plataforma {{site.data.keyword.blockchainfull_notm}} y proporcionan un entorno de desarrollo con herramientas y tecnologías estándares del sector. Puede desarrollar su red en el entorno en línea o de forma local. Después de desarrollar una red, puede desplegarla en la red del Plan empresarial.
...
La pantalla "Obtener ayuda" contiene un separador "Soporte" que proporciona una lista de recursos para desarrolladores y un separador "Notas del release" que describe las funciones nuevas de la plataforma {{site.data.keyword.blockchainfull}}.
...
Al crear una instancia del Plan inicial o el Plan empresarial, la plataforma {{site.data.keyword.blockchainfull_notm}} asigna un nombre a la red. Sin embargo, puede actualizar este nombre de red en cualquier momento en el Supervisor de red.
