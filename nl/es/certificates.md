...
Visite la [guía de aprendizaje de desarrollo de aplicaciones](v10_application.html) para aprender a [inscribir mediante el SDK de nodo de Fabric](v10_application.html#enroll-app). La inscripción con el SDK genera 3 elementos independientes: una clave privada, un signCert y una clave pública que se ha utilizado para crear el signCert.
...
[API de Swagger](howto/swagger_apis.html) para añadir un certificado de administrador.
...
- **cacerts** e **intermediatecerts**: puede recuperar estos certificados con las [API de Swagger](howto/swagger_apis.html) emitiendo una solicitud Get a la API de MSP.
...
[trabajar con un igual remoto](howto/peer_operate_icp.html#peer-cli-operate).
