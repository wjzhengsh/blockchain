...
Cada miembro de red debe tener una cuenta de pago de {{site.data.keyword.cloud_notm}}, por ejemplo, una cuenta de **Pago según uso**, para poder crear instancias de servicio de la plataforma {{site.data.keyword.blockchainfull_notm}} en {{site.data.keyword.cloud_notm}}. Si no tiene una cuenta, [registre](https://console.bluemix.net/registration/) una y actualícela a una cuenta de pago. Para actualizar su cuenta a un tipo Pago según uso, vaya a **Gestionar** > **Facturación y uso** > **Facturación** en la consola de {{site.data.keyword.cloud_notm}}, y pulse **Añadir tarjeta de crédito**.
...
3. El pagador crea una plataforma {{site.data.keyword.blockchainfull_notm}} de la cadena de blockchain e invita a otros miembros a la red de blockchain en el supervisor de red de la red. Para obtener más información sobre cómo invitar a miembros de la red, consulte [Miembros](https://console.bluemix.net/docs/services/blockchain/v10_dashboard.html#members).
4. Luego cada miembro recibe una notificación por correo electrónico que contiene una invitación a unirse a la red. El miembro puede seguir los pasos siguientes para unirse a la red.
   ...
   3. En el catálogo de {{site.data.keyword.cloud_notm}}, busque **Blockchain** y cree una instancia de servicio.
      ...
      4. Pulse **Crear**.
   4. Después de crear la instancia del servicio blockchain, siga las instrucciones del asistente para unirse a la red.  Para obtener más información, consulte [Cómo unirse a una red](https://console.bluemix.net/docs/services/blockchain/get_start.html#joining-a-network).
...
1. El pagador crea una plataforma {{site.data.keyword.blockchainfull_notm}} de la cadena de blockchain con la cuenta del pagador.
...
3. El pagador invita a otros miembros a la red de blockchain en el supervisor de red de la red. Para obtener más información sobre cómo invitar a miembros de la red, consulte [Miembros](https://console.bluemix.net/docs/services/blockchain/v10_dashboard.html#members).
4. Luego cada miembro recibe una notificación por correo electrónico que contiene una invitación a unirse a la red. A continuación, el miembro puede unirse a la red. Para obtener más información, consulte el **paso 4** de la sección [Cómo pagar por otros miembros de la red](#pay-for-others).
