...
3. Especifique la [política de aprobación](/docs/services/blockchain/glossary.html#endorsement-policy) del código de encadenamiento. Puede obtener más información sobre cómo establecer políticas de aprobación en la [sección siguiente](#specifying-chaincode-endorsement-policies).
