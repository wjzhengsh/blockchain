...
Cada componente genera registros de distintas actividades. Esto se debe a que cada componente juega distintos roles dentro de la [arquitectura de red ![Icono de enlace externo](../images/external_link.svg "Icono de enlace externo")](https://hyperledger-fabric.readthedocs.io/en/release-1.2/network/network.html) de Hyperledger Fabric y en los [flujos de transacciones ![Icono de enlace externo](../images/external_link.svg "Icono de enlace externo")](https://hyperledger-fabric.readthedocs.io/en/release-1.2/txflow.html).
