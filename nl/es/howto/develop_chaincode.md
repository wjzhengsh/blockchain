...
[SDK de Fabric](/docs/services/blockchain/v10_application.html#dev-app-operate-sdk). Para obtener información sobre cómo utilizar la interfaz de usuario del supervisor de red para desplegar código de encadenamiento, consulte [Instalación, creación de instancias y actualización de un código de encadenamiento](/docs/services/blockchain/howto/install_instantiate_chaincode.html#install-instantiate-chaincode).
