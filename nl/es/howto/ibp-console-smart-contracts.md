...
2. Pulse **Instalar contrato inteligente** para cargar el archivo del paquete del contrato inteligente en [formato .cds ![Icono de enlace externo](../images/external_link.svg "Icono de enlace externo")](https://hyperledger-fabric.readthedocs.io/en/release-1.4/chaincode4noah.html#packaging "empaquetado de contratos inteligentes").
