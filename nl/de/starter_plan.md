...
- **Cloud-Punkte von {{site.data.keyword.blockchainfull_notm}} Platform**
    ...
    Weitere Informationen zur Verwendung des Testguthabens finden Sie im [Leitfaden zur Preisstruktur](howto/pricing.html#starter-plan-pricing).
