...
In Zukunft wird die Migration von einem Enterprise Plan-Release auf die allgemein verfügbare Version (GA-Version) von {{site.data.keyword.blockchainfull_notm}} Platform 2.0 möglich sein.   

Weder die kostenlosen Betaserviceinstanzen von {{site.data.keyword.blockchainfull_notm}} Platform 2.0 noch Starter Plan-Instanzen können auf die allgemein verfügbare Version 2.0 migriert werden.
