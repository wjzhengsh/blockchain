...
- {{site.data.keyword.blockchainfull_notm}} Platform on {{site.data.keyword.cloud_notm}}는 Hyperledger Fabric v1.4로 빌드됩니다.
...
- 인증서 및 개인 키에 대한 관리와 보안은 사용자의 책임입니다. IBM은 사용자의 인증서를 Kubernetes 클러스터에 저장하지 않습니다.
...
{{site.data.keyword.blockchainfull_notm}} Platform 콘솔과 {{site.data.keyword.blockchainfull_notm}} Platform on {{site.data.keyword.cloud_notm}} 배치를 시작하는 방법에 대해 자세히 알아보려면 다음 [동영상 시리즈]( http://ibm.biz/BlockchainPlatformSeries)를 시청하십시오.
...
**새 클러스터 작성**을
클릭하여 {{site.data.keyword.cloud_notm}} Kubernetes 대시보드를 시작하여 클러스터를 작성하십시오. 자세한 정보는 [{{site.data.keyword.cloud_notm}} Kubernetes Service 시작하기 ![외부 링크 아이콘](../images/external_link.svg "외부 링크 아이콘")](/docs/containers/getting-started.html)를 참조하십시오. 이 프로세스가 완료될 때까지 추가 시간이 필요할 수 있습니다.
...
서비스 인스턴스를 배치한 후 콘솔로 돌아가야 하는 경우 {{site.data.keyword.cloud_notm}} 대시보드에서 이동할 수 있습니다.
1. 브라우저에서 https://cloud.ibm.com/resources로 이동하여 로그인하십시오.
...
3. 후속 패널에서 **{{site.data.keyword.blockchainfull_notm}} Platform 실행**을 클릭하십시오.
...
- {{site.data.keyword.blockchainfull_notm}} Platform 가격 정보를 다시 방문해야 하는 경우 [가격](/docs/services/blockchain/howto?topic=blockchain-ibp-saas-pricing)에서 이 주제를 참조하십시오.
- 현재 {{site.data.keyword.cloud_notm}} 사용량 정보는 {{site.data.keyword.cloud_notm}} 대시보드의 [사용량 타일 ![외부 링크 아이콘](../images/external_link.svg "외부 링크 아이콘")](https://cloud.ibm.com/billing/ "청구 및 사용량")에서 볼 수 있고 청구서는 [청구 정보 ![외부 링크 아이콘](../images/external_link.svg "외부 링크 아이콘")](https://cloud.ibm.com/billing/billing-items "청구 항목") 아래에 표시됩니다. {{site.data.keyword.blockchainfull_notm}} Platform 청구 작동 방법에 대한 세부사항은 [청구](/docs/services/blockchain/howto?topic=blockchain-ibp-saas-pricing#ibp-saas-pricing-billing)에서 이 주제를 참조하십시오.
