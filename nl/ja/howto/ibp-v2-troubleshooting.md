...
- [VSCode から実行するトランザクションが失敗するのはなぜですか?](/docs/services/blockchain/howto/ibp-v2-troubleshooting.html#ibp-v2-troubleshooting-anchor-peer)
...
## VSCode から実行するトランザクションが失敗するのはなぜですか?
{: #ibp-v2-troubleshooting-anchor-peer}

VSCode からトランザクションを実行すると、以下のようなエラーが出て失敗します。
```
